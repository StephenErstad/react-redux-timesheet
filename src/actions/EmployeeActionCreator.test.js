describe('employee actions', () => {
  ...
  describe('async actions', () => {
    ...
    it('creates LIST when fetching employees has been done', () => {
      ...
      return store.dispatch(actions.listEmployees()).then(() => { // return of async actions
    ...
    it('create GET when requesting single employee', () => {
      ...
      return store.dispatch(actions.getEmployee(1)).then(() => { // return of async actions
        expect(store.getActions()).toEqual(expectedActions);
      });
    ...
    it('create GET when updating a employee', () => {
      ...
      return store.dispatch(actions.updateEmployee({ _id: 1 })).then(() => { // return of async actions
        expect(store.getActions()).toEqual(expectedActions);
      });
    ...
    it('create GET when removing a employee', () => {
      ...
      return store.dispatch(actions.removeEmployee({ _id: 1 })).then(() => { // return of async actions
        expect(store.getActions()).toEqual(expectedActions);
      });
    ...
    it('create GET when restoring a employee', () => {
      ...
      return store.dispatch(actions.restoreEmployee({ _id: 1 })).then(() => { // return of async actions
        expect(store.getActions()).toEqual(expectedActions);
      });
